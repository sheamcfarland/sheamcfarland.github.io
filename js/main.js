...
document.getElementById('phonelink').innerText = document.getElementById('name').placeholder
document.getElementById('phonelink').innerText = document.getElementById('title').placeholder
